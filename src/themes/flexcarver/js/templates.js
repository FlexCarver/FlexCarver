...
this["templates"]["newsitem"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div data-id=\""
    ...
    + "@m\""
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"single") : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":149},"end":{"line":1,"column":215}}})) != null ? stack1 : "")
    + ">";
  ...
  buffer += "\r\n    <div class=\"newsitem-banner\" style=\"border-top: 8px solid "
    ...
    + "</div>\r\n";
  stack1 = ((helper = (helper = lookupProperty(helpers,"innerRender") || (depth0 != null ? lookupProperty(depth0,"innerRender") : depth0)) != null ? helper : alias2),(options={"name":"innerRender","hash":{},"fn":container.noop,"inverse":container.program(10, data, 0),"data":data,"loc":{"start":{"line":8,"column":0},"end":{"line":8,"column":38}}}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
  if (!lookupProperty(helpers,"innerRender")) { stack1 = alias4.call(depth0,stack1,options)}
  if (stack1 != null) { buffer += stack1; }
  return buffer;
},"useData":true});
